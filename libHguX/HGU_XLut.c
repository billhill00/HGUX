...
#else static char _HGU_XLut_c[] = "MRC HGU $Id:";
#endif
#endif
/*!
* \file         HGU_XLut.c
* \author       Richard Baldock <Richard.Baldock@hgu.mrc.ac.uk>
* \date         Wed Apr 29 08:18:22 2009
* \version      MRC HGU $Id$
*               $Revision$
*               $Name$
* \par Address:
...
* \ingroup      HGU_X
* \brief         Convenience routines to manipulate look-up tables
*               using the grey-transform associated with a PframeX structure
* \todo         -
* \bug          None known
*
